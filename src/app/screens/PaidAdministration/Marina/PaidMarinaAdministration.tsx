...
export default function PaidMarinaAdministrationScreen() {
  const navigation = useNavigation<any>()

  const goBack = () => navigation.goBack()
  const closeAll = () => navigation.popToTop()

  const openMinhaMarina = () => navigation.navigate('MyMarina') // ajuste o nome da rota se necessário
  const openServicos = () => navigation.navigate('MarinaServices') // ajuste o nome da rota se necessário
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <MenuItem
          label="Minha marina"
          onPress={openMinhaMarina}
          icon={<HelmIcon />}
        />
        <MenuItem
          label="Serviços"
          onPress={openServicos}
          icon={<CoffeeIcon />}
        />
      </ScrollView>
    </View>
...
function HelmIcon() {
  ...
  return (
    <Svg width={22} height={22} viewBox="0 0 24 24">
      ...
      />
      <Path
        d="M12 2v4M12 18v4M2 12h4M18 12h4M4.2 4.2l2.8 2.8M17 17l2.8 2.8M4.2 19.8L7 17M17 7l2.8-2.8"
        stroke="#D6DEE9"
        strokeWidth={2}
        strokeLinecap="round"
      />
...
function CoffeeIcon() {
  ...
  return (
    <Svg width={22} height={22} viewBox="0 0 24 24">
      ...
      />
      <Path
        d="M11 5c0 1 .8 1.2.8 2s-.8 1-.8 2"
        stroke="#D6DEE9"
        strokeWidth={2}
        strokeLinecap="round"
        fill="none"
